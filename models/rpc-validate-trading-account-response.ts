...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcValidateTradingAccountResponseData } from './rpc-validate-trading-account-response-data';

/**
 * Response for trading account validation
 */
export interface RpcValidateTradingAccountResponse {
    'data'?: RpcValidateTradingAccountResponseData;
    'error'?: RpcError;
}
