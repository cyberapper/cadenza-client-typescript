...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcTradingAccountOperationHistory } from './rpc-trading-account-operation-history';

/**
 * Response for listing trading account operations
 */
export interface RpcListTradingAccountOperationsResponse {
    'data'?: Array<RpcTradingAccountOperationHistory>;
    'error'?: RpcError;
}
