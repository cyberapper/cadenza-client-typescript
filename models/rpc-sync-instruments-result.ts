...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcSyncInstrumentsResultData } from './rpc-sync-instruments-result-data';

/**
 * Response for instrument sync
 */
export interface RpcSyncInstrumentsResult {
    'data'?: RpcSyncInstrumentsResultData;
    'error'?: RpcError;
}
