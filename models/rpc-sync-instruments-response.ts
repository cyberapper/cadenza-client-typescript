...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcSyncInstrumentsResponseData } from './rpc-sync-instruments-response-data';

/**
 * Response for instrument sync
 */
export interface RpcSyncInstrumentsResponse {
    'data'?: RpcSyncInstrumentsResponseData;
    'error'?: RpcError;
}
