...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcVerifyCredentialResponseData } from './rpc-verify-credential-response-data';

/**
 * Response for credential verification
 */
export interface RpcVerifyCredentialResponse {
    'data'?: RpcVerifyCredentialResponseData;
    'error'?: RpcError;
}
