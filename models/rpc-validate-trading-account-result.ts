...
// May contain unused imports in some cases
// @ts-ignore
import type { RpcValidateTradingAccountResultData } from './rpc-validate-trading-account-result-data';

/**
 * Response for trading account validation
 */
export interface RpcValidateTradingAccountResult {
    'data'?: RpcValidateTradingAccountResultData;
    'error'?: RpcError;
}
