...
**data** | [**Ticker**](Ticker.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetMarketTicker200Response } from '@cyberapper/cadenza-client';

const instance: GetMarketTicker200Response = {
    success,
    errno,
    error,
    details,
