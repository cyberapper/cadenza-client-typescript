...
**data** | [**TradeOrder**](TradeOrder.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CancelTradeOrder200Response } from '@cyberapper/cadenza-client';

const instance: CancelTradeOrder200Response = {
    success,
    errno,
    error,
    details,
