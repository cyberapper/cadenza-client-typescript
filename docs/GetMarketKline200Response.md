...
**data** | [**Kline**](Kline.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetMarketKline200Response } from '@cyberapper/cadenza-client';

const instance: GetMarketKline200Response = {
    success,
    errno,
    error,
    details,
