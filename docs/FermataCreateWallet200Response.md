...
**data** | [**FermataWallet**](FermataWallet.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FermataCreateWallet200Response } from '@cyberapper/cadenza-client';

const instance: FermataCreateWallet200Response = {
    success,
    errno,
    error,
    details,
