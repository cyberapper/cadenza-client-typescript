...
**data** | [**Array&lt;TradingAccountCredential&gt;**](TradingAccountCredential.md) |  | [optional] [default to undefined]
**pagination** | [**Pagination**](Pagination.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ListTradingAccountCredentials200Response } from '@cyberapper/cadenza-client';

const instance: ListTradingAccountCredentials200Response = {
    success,
    errno,
    error,
    details,
