...
**data** | [**Array&lt;TradeOrder&gt;**](TradeOrder.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SubmitTradeOrder200Response } from '@cyberapper/cadenza-client';

const instance: SubmitTradeOrder200Response = {
    success,
    errno,
    error,
    details,
