...
**data** | [**Array&lt;Instrument&gt;**](Instrument.md) |  | [optional] [default to undefined]
**pagination** | [**Pagination**](Pagination.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ListMarketInstruments200Response } from '@cyberapper/cadenza-client';

const instance: ListMarketInstruments200Response = {
    success,
    errno,
    error,
    details,
