...
**data** | [**TradingAccountCredential**](TradingAccountCredential.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CreateTradingAccountCredential200Response } from '@cyberapper/cadenza-client';

const instance: CreateTradingAccountCredential200Response = {
    success,
    errno,
    error,
    details,
