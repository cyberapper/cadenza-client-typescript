...
**data** | [**Array&lt;Orderbook&gt;**](Orderbook.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ListMarketOrderBooks200Response } from '@cyberapper/cadenza-client';

const instance: ListMarketOrderBooks200Response = {
    success,
    errno,
    error,
    details,
