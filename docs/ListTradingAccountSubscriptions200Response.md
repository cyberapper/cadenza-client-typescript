...
**data** | [**Array&lt;Subscription&gt;**](Subscription.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ListTradingAccountSubscriptions200Response } from '@cyberapper/cadenza-client';

const instance: ListTradingAccountSubscriptions200Response = {
    success,
    errno,
    error,
    details,
