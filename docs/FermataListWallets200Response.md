...
**data** | [**Array&lt;FermataWallet&gt;**](FermataWallet.md) |  | [optional] [default to undefined]
**pagination** | [**Pagination**](Pagination.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FermataListWallets200Response } from '@cyberapper/cadenza-client';

const instance: FermataListWallets200Response = {
    success,
    errno,
    error,
    details,
