...
**data** | [**AuthSession**](AuthSession.md) |  | [optional] [default to undefined]

## Example

```typescript
import { AuthSignup200Response } from '@cyberapper/cadenza-client';

const instance: AuthSignup200Response = {
    success,
    errno,
    error,
    details,
