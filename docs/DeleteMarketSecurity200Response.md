...
**data** | [**FinancialSecurity**](FinancialSecurity.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DeleteMarketSecurity200Response } from '@cyberapper/cadenza-client';

const instance: DeleteMarketSecurity200Response = {
    success,
    errno,
    error,
    details,
