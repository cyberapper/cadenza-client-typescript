...
**data** | [**FermataDealer**](FermataDealer.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FermataCreateDealer200Response } from '@cyberapper/cadenza-client';

const instance: FermataCreateDealer200Response = {
    success,
    errno,
    error,
    details,
