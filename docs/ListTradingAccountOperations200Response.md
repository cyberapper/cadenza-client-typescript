...
**data** | [**Array&lt;AccountOperation&gt;**](AccountOperation.md) |  | [optional] [default to undefined]
**pagination** | [**Pagination**](Pagination.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ListTradingAccountOperations200Response } from '@cyberapper/cadenza-client';

const instance: ListTradingAccountOperations200Response = {
    success,
    errno,
    error,
    details,
